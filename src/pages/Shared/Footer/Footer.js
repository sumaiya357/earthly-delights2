...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 bg-green-700 text-primary-content">
                <div>
                ...
                <div>
                    ...
                    <div className="form-control ">
                        ...
                        <div className="relative">
                            ...
                            <button className="btn btn-outline btn-success absolute top-0 right-0 rounded-l-none"> <FontAwesomeIcon className='text-green-800'  icon={faSearch}></FontAwesomeIcon></button>
