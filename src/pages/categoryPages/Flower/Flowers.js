...
const Flowers = (props) => {
    ...
    const handleDeleteProduct = flower => {
        fetch(`http://localhost:5000/flowers/${flower._id}`, {
            method: 'DELETE',
            headers: {
            ...
            <div className="card w-48 glass">
                ...
                <div className="card-body">
                    ...
                    jasmine https://cdn.shopify.com/s/files/1/0061/6389/0289/products/Jamsin8_x700.jpg?v=1632929983*/}
                        ...
                        {
                            isAdmin && <>
                                <label onClick={() => setDeletProduct(props.flower)} htmlFor="delet-modal" className="btn btn-error  btn-sm text-white">Delet  <FontAwesomeIcon className='ml-2' icon={faDeleteLeft}></FontAwesomeIcon></label>
                            </>
                        }
